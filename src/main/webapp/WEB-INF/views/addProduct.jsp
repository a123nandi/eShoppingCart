    ...
    <div class="container">
        ...
        <form:form action="${pageContext.request.contextPath}/admin/product/addProduct"
            ...
            <div class="form-group">
                ...
                <label class="checkbox-inline"><form:radiobutton path="productStatus" id="status" value="Inactive" />Unavailable</label>
            </div>
            ...
            <div class="form-group">
                <label for="manufacturer">Manufacturer Place</label>
